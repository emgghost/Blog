...
const config = { theme, corePlugins, plugins, important, content, presets, darkMode, prefix, separator, safelist, blocklist }
export { config as default, theme, corePlugins, plugins, important, content, presets, darkMode, prefix, separator, safelist, blocklist }